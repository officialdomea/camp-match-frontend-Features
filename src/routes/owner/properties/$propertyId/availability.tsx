...
export const Route = createFileRoute("/owner/properties/$propertyId/availability")({
...
function OwnerAvailabilityPage() {
  ...
  const { data, isPending, isError, error, refetch } = useProperty(propertyId);
        ...
        <div className="px-4 py-6 sm:px-6">
          {appError.code === "NOT_FOUND" ? (
            <ErrorState
              ...
              description="The property you’re trying to manage no longer exists."
            />
          ) : (
    ...
    <AppShell>
      <div className="space-y-6 px-4 py-6 sm:px-6">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-wide text-muted-foreground">Property owner</p>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Optional note for students and scouts"
              />
            </div>
          </div>
        </Card>
